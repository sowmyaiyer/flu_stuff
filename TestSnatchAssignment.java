...
public class TestSnatchAssignment {
	...
	public static void main(String[] args) {
			...
			double reads_multi_to_A_and_B_and_C = 1000;
			...
			{
				double snatch_readcount_t_plus_1_A = snatch_pref_t_A_normalized*snatch_read_count_t_A + reads_multi_to_A_and_B_and_C * (theta_t_A/(theta_t_A + theta_t_B+ theta_t_C))*(snatch_pref_t_A_normalized/(snatch_pref_t_A_normalized+snatch_pref_t_B_normalized + snatch_pref_t_C_normalized));
				double snatch_readcount_t_plus_1_B = snatch_pref_t_B_normalized*snatch_read_count_t_B + reads_multi_to_A_and_B_and_C * (theta_t_B/(theta_t_A + theta_t_B + theta_t_C))*(snatch_pref_t_B_normalized/(snatch_pref_t_A_normalized+snatch_pref_t_B_normalized + snatch_pref_t_C_normalized));
				double snatch_readcount_t_plus_1_C = snatch_pref_t_C_normalized*snatch_read_count_t_C + + reads_multi_to_A_and_B_and_C * (theta_t_C/(theta_t_A + theta_t_B + theta_t_C))*(snatch_pref_t_C_normalized/(snatch_pref_t_A_normalized+snatch_pref_t_B_normalized + snatch_pref_t_C_normalized));;
